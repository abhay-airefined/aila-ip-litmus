...
- This implementation includes an internal model-output simulation gateway (`app/utils/model_gateway.py`) so the system is runnable end-to-end without external model APIs.
- Replace that module with provider-specific model calls for production deployment against real target models.
